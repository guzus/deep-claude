...
- Refactor GetPRChecks to use 'gh pr view' for improved compatibility and enhance JSON parsing for status checks (fb04686)
- Enhance error handling and repository checks in GitHub and Orchestrator modules (c63a24f)
- :bookmark: Release version v0.2.3 (4feae01)
- Claude/automate binary releases ut jz o (#7) (9391fd1)
- :bookmark: Release version v0.2.2 (f6d0a6e)
- Port to Go (9962e97)
...
- Claude/update readme install docs h6ir0 (#6) (061cc1e)

**Full Changelog**: https://github.com/guzus/continuous-claude/compare/v0.2.0...v0.2.1

## [v0.2.0] - 2025-12-26

### What's Changed

- :sparkles: Add GitHub release creation to auto-release workflow (#5) (6a44621)

**Full Changelog**: https://github.com/guzus/continuous-claude/compare/v0.1.1...v0.2.0
...
- :sparkles: Port Continuous Claude to Go for better scalability (#1) (6c9bc62)
- :pencil: Update logo, link to license (5a5492f)
- :pencil: Revise README to include logo (53d9493)
- :bookmark: Release version v0.14.0 (4bd9e13)
- :recycle: Refine waiting logic in wait_for_pr_checks function (d246e62)
...
**Full Changelog**: https://github.com/guzus/continuous-claude/compare/v0.0.0...v0.1.0
